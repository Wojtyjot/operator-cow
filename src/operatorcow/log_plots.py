...
def plot_pred_paper(
    ...
    axs[0, 0].plot(unit_to_mmHg(ground_truth[:50, 0]), label="Ground truth", color="black", linewidth=1)
    axs[0, 0].plot(unit_to_mmHg(predictions[:50, 0]), label="Predicted", color="red", linestyle="--", linewidth=1)
    ...
    axs[0, 1].plot(ground_truth[:50, 1], label="Ground truth", color="black",  linewidth=1)
    axs[0, 1].plot(predictions[:50, 1], label="Predicted", color="red", linestyle="--", linewidth=1)
    ...
    axs[0, 1].grid()
    axs[1, 0].plot(ground_truth[:50, 2], label="Ground truth", color="black", linewidth=1)
    axs[1, 0].plot(predictions[:50, 2], label="Predicted", color="red", linestyle="--", linewidth=1)
    ...
    axs[1, 0].grid()
    axs[1, 1].plot(ground_truth[:50, 2] * ground_truth[:50, 1], label="Ground truth", color="black", linewidth=1)
    axs[1, 1].plot(predictions[:50, 2] * predictions[:50, 1], label="Predicted", color="red", linestyle="--", linewidth=1)
