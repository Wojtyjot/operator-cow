...
from train_new import train_VANO
...
@hydra.main(version_base=None, config_path="configs", config_name="VANO_exp")
def main(config: DictConfig) -> None:
    ...
    # Load model
    if config.model.name == "VANO":

        model = VANO(
            layers_encoder=config.model.layers_encoder,
            layers_decoder=config.model.layers_decoder,
