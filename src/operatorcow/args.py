...
def get_args():
    ...
    parser.add_argument(
        "--normalize_x", type=str, default="unit", choices=["none", "minmax", "unit"]
    )
    parser.add_argument(
        "--use-normalizer",
        type=str,
    ...
    parser.add_argument(
        "--optimizer", type=str, default="AdamW", choices=["Adam", "AdamW"]
    )
    ...
    parser.add_argument(
        "--lr-method", type=str, default="cycle", choices=["cycle", "step", "warmup"]
    )
    parser.add_argument("--lr-step-size", type=int, default=50)
    parser.add_argument("--warmup-epochs", type=int, default=50)

    parser.add_argument(
        "--loss-name", type=str, default="rel2", choices=["rel2", "rel1", "l2", "l1"]
    )
    ...
    # common
    parser.add_argument(
        "--act", type=str, default="gelu", choices=["gelu", "relu", "tanh", "sigmoid"]
    )
