...
function saveTempData(t :: Float64, v :: Vessel, counter :: Int)# change to get full mesh
	#=
	...
	=#
	v.P_t[counter,:] = vcat(t ,v.P)
	v.A_t[counter,:] = vcat(t, v.A)
	v.Q_t[counter,:] = vcat(t, v.Q)
	v.u_t[counter,:] = vcat(t, v.u)
	v.c_t[counter,:] = vcat(t, v.c)
end
