...
def main(config: DictConfig) -> None:
    ...
    for subfolder in val_path.iterdir():
        if subfolder.is_dir():
            ...
            fig_path = (
                "/home/wssk-ptw/Operator/COW_DATASET_WRO_1_PI/WYNIKI/TEST_WINDKESSEL/"
                + str(subfolder.name)
            )
            rec_path = (
                "/home/wssk-ptw/Operator/COW_DATASET_WRO_1_PI/WYNIKI/TEST_WINDKESSEL_rec_sol/"
                + str(subfolder.name)
            )
    ...
    with open(
        "/home/wssk-ptw/Operator/COW_DATASET_WRO_1_PI/WYNIKI/TEST_WINDKESSEL/arteries_log.pkl",
        "wb",
    ) as f:
